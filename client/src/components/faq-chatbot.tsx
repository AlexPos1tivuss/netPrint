...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Стоимость доставки зависит от вашего региона и размера заказа. При оформлении заказа вы увидите точную стоимость доставки. Бесплатная доставка по Беларуси при заказе от 100 Br."
  },
  {
  ...
  },
  {
    ...
    answer: "Да! Мы предлагаем услуги профессиональных фотографов. При оформлении заказа выберите опцию 'Заказать фотографа', укажите дату, время и место съемки. Стоимость услуг фотографа начинается от 70 Br в час."
  },
  {
