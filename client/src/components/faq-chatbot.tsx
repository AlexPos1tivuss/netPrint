...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Стоимость доставки зависит от вашего региона и размера заказа. При оформлении заказа вы увидите точную стоимость доставки. Бесплатная доставка по Беларуси при заказе от 100 BYN."
  },
  {
    question: "Как долго выполняется заказ?",
    answer: "Стандартный срок изготовления — 3-5 рабочих дней. Срочное изготовление (1-2 дня) доступно за дополнительную плату. Доставка по Минску занимает 1-2 дня, по Беларуси — 2-5 дней."
  },
  {
    question: "Можно ли заказать фотографа?",
    answer: "Да! Мы предлагаем услуги профессиональных фотографов. При оформлении заказа выберите опцию 'Заказать фотографа', укажите дату, время и место съемки. Стоимость услуг фотографа начинается от 70 BYN в час."
  },
  {
