        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground">
              Фотоальбомы, фотографии и календари с быстрой доставкой
            </p>
            <div className="flex flex-wrap gap-3 justify-center">
              <Badge variant="secondary" className="px-3 py-1">Высокое качество</Badge>
              <Badge variant="secondary" className="px-3 py-1">Быстрая доставка</Badge>
              <Badge variant="secondary" className="px-3 py-1">Тысячи клиентов</Badge>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold mb-2">Выберите тип продукта</h2>
            ...
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <p className="text-muted-foreground mb-6">
                  ...
                  Мы поможем создать незабываемые снимки.
                </p>
                <div>
                  <Button 
                    size="lg"
              ...
              <div className="bg-gradient-to-br from-primary/20 to-primary/10 p-12 hidden md:flex items-center justify-center">
                <Camera className="h-40 w-40 text-primary/20" />
              </div>
            </div>
          </Card>
        </div>
      ...
      <Dialog open={!!editingProduct} onOpenChange={(open) => !open && setEditingProduct(null)}>
        <DialogContent data-testid="dialog-edit-product">
          <DialogHeader>
            ...
            <DialogDescription>
              Измените название, описание, цену или изображение
            </DialogDescription>
          </DialogHeader>
